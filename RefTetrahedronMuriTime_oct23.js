...
findTimeDuration( ){
let Radius = new RefLine(this.center, this.points[0]);
let R2 = Radius.distance;
let L2 = lr(this.lines[0]).distance;
let r2 = R2 * R2;
let l2 = L2 * L2;
let t2 = l2 - r2;
console.log("time gets here");
this.duration = wholeroot(t2, 2, 10);
